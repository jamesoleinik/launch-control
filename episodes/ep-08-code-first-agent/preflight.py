...
Usage:
    python episodes/ep-08-code-first-agent/preflight.py            # P1-P7 only (no network)
    python episodes/ep-08-code-first-agent/preflight.py --live     # also runs S1 (live skill sync)
