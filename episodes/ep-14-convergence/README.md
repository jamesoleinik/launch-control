# Episode 14: Convergence (native Copilot and the three IQ agents, together)
...
| **Web IQ (Ep 12)** | + live web | the CDN vendor had an outage; the security blocker maps to a live CVE |
| **Fabric IQ (Ep 10)** | + semantic baseline | 8 blockers is a statistical outlier for this phase |
| **Foundry IQ (Ep 13)** | + federated docs | the cited security standard and vendor SLA behind the judgment |
