...
Copilot Studio in [Episode 9](../../episodes/archive/ep-09-the-agent/README.md). Same job. Same
skill. Different runtime.

## The point

By Episode 11 we have *three* agents that all do launch readiness:
...
```
                ...
                ┌────────────────┼─────────────────────┐
                │                │                     │
        Ep 9 Coordinator   Ep 10 Sentinel        Ep 11 Coordinator (this)
...
The **on-camera moment** for Episode 11: scroll back through the agent's tool
...
- Episode 9 doc — the Copilot Studio Coordinator that authored the same skill
- Episode 10 doc — Launch Sentinel, autonomous, same brain
