"""Episode 9 preflight: verify the demo data is rich enough for the gen-page recording.
...
Run: python episodes/ep-09-the-dashboard/preflight.py
"""
...
def main():
    ...
    if failures:
        ...
        return 1
    print("✅ All checks passed — Ep 9 demo data is recording-ready.")
    return 0
