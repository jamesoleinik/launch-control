# build.ps1 - stage + zip the Cowork "Dataverse EppcDemo2FRE" plugin (preview MCP).
#
...
#
# Output:
#   .\out\dataverse-eppcdemo2fre-cowork.zip   <- upload this to M365 Admin Center
...
$zip = Join-Path $out "dataverse-eppcdemo2fre-cowork.zip"
...
Write-Host ""
Write-Host "=== Cowork 'Dataverse EppcDemo2FRE' package built ===" -ForegroundColor Green
Write-Host "  MCP endpoint  : https://eppcdemo2fre.crm.dynamics.com/api/mcp_preview"
