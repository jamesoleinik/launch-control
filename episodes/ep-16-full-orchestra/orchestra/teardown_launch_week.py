...
Use:
  python episodes/ep-16-full-orchestra/orchestra/teardown_launch_week.py --dry-run
  python episodes/ep-16-full-orchestra/orchestra/teardown_launch_week.py --apply
"""
