...
Two modes:
  python episodes/ep-06-the-agent/preflight.py --plan       # Emit human-readable test plan (markdown)
  python episodes/ep-06-the-agent/preflight.py --run        # Execute tests, print colorized summary, write results md
  python episodes/ep-06-the-agent/preflight.py --plan --run # Both: show plan, then run
...
_Generated by `episodes/ep-06-the-agent/preflight.py`. Re-run after substrate changes._
