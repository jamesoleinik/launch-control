...
Usage:
    python launch-control/scripts/python/upload_knowledge.py
    python launch-control/scripts/python/upload_knowledge.py --dry-run
    python launch-control/scripts/python/upload_knowledge.py --only escalation-policy.md
"""
