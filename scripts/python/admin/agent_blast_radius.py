"""scripts/python/admin/agent_blast_radius.py
...
Use:
  python scripts/python/admin/agent_blast_radius.py
  python scripts/python/admin/agent_blast_radius.py --json
  python scripts/python/admin/agent_blast_radius.py --custom-only
"""
