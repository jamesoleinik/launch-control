...
**Hero file in repo:** `episodes/_ep-13-copilot-mcp-app/declarative-agent/appPackage/actions/dataverse-mcp.action.json`
...
> `episodes/_ep-13-copilot-mcp-app/declarative-agent/appPackage/actions/dataverse-mcp.action.json`
...
- [ ] `episodes/_ep-13-copilot-mcp-app/` renamed to
...
- [Ep 6 — The Agent](../ep-06-the-agent/README.md) — the Copilot Studio
  contrast point (same data, different surface)
- [Ep 12 — Full Orchestra](../ep-12-full-orchestra/README.md) — finale that
