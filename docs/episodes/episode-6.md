...
[`scripts/test_ep6_locally.py`](../../scripts/test_ep6_locally.py) is a
two-mode harness:

```powershell
python scripts/test_ep6_locally.py --plan       # Markdown plan for review
python scripts/test_ep6_locally.py --run        # Execute, print summary
```
...
6. **Test harness** — `python scripts/test_ep6_locally.py --plan` to show
...
| [`scripts/python/upload_knowledge.py`](../../scripts/python/upload_knowledge.py) | Idempotent uploader: upserts records, uploads files via SDK |
| [`scripts/create_knowledge_table.py`](../../scripts/create_knowledge_table.py) | Idempotent table creator (Ep 3 Part 2) |
| [`scripts/test_ep6_locally.py`](../../scripts/test_ep6_locally.py) | This episode's substrate harness — `--plan` and `--run` |
...
python scripts/python/upload_knowledge.py

# Verify the substrate is ready
python scripts/test_ep6_locally.py --run
