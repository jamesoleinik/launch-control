...
|-----------|------------------------|-------------------|
| Copilot Studio (Ep 6) | Via MCP Server tool | Via registered MCP connector |
| Autonomous Agent (Ep 7) | Via event-triggered action | Via agent flow MCP step |
| Claude Code (Ep 8) | Via SDK/Web API | Via MCP client |
| M365 Copilot (Ep 9) | Via Dataverse Intelligence | Not directly available |
