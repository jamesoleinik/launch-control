"""Episode 15 preflight: verify the demo env is in the state Ep 15 needs.

Ep 15 = administration/management plane is agent-driven. Five proof points:
...
Run: python episodes/ep-15-agentic-admin/preflight.py
"""
import os, sys
import requests
