...
The "Launch Control" LinkedIn series — fifteen short episodes building one project end-to-end. Each folder is self-contained: the episode README is the spec, `preflight.py` is the local test harness, and any episode-specific scripts live alongside.
