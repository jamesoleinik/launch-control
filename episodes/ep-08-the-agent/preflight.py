"""Local test harness for Episode 8 — The Agent.

Two modes:
  python episodes/ep-08-the-agent/preflight.py --plan       # Emit human-readable test plan (markdown)
  python episodes/ep-08-the-agent/preflight.py --run        # Execute tests, print colorized summary, write results md
  python episodes/ep-08-the-agent/preflight.py --plan --run # Both: show plan, then run
...
PROMPT_DOC = """# Episode 8 — Manual Prompt Set (Copilot Studio Test panel)

_Generated by `episodes/ep-08-the-agent/preflight.py`. Re-run after substrate changes._
