"""Episode 10 prompt preflight: verify the data shape Dataverse Intelligence will need
...
Run: python scripts/python/audit_ep10_prompts.py
"""
import os, sys
import requests
...
def main():
    print(f"Episode 10 prompt preflight (launch: {LAUNCH_NAME!r})\n")
    failures = 0
