"""Local test harness for Episode 7 — The Agent.

Two modes:
  python episodes/ep-07-the-agent/preflight.py --plan       # Emit human-readable test plan (markdown)
  python episodes/ep-07-the-agent/preflight.py --run        # Execute tests, print colorized summary, write results md
  python episodes/ep-07-the-agent/preflight.py --plan --run # Both: show plan, then run
...
PROMPT_DOC = """# Episode 7 — Manual Prompt Set (Copilot Studio Test panel)
