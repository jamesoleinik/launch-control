"""Ep 12 outside-in demo: fuse internal launch blockers with live Web IQ signal.

This proves the Episode 12 thesis in code before it is wired into the Copilot
...
def main():
    ...
    try:
        client = WebIqClient(env_name="ep-12-dataverse-webiq")
