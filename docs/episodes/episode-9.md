...
python ../../scripts/python/_set_genpage_default.py
```
...
```bash
python scripts/test_ep9_locally.py
```
...
- `docs/episodes/episode-9.md` — this file
- `scripts/test_ep9_locally.py` — preflight harness
...
- [ ] `python scripts/test_ep9_locally.py` returns all green
