...
Usage:
    python launch-control/episodes/ep-07-the-agent/upload_knowledge.py
    python launch-control/episodes/ep-07-the-agent/upload_knowledge.py --dry-run
    python launch-control/episodes/ep-07-the-agent/upload_knowledge.py --only escalation-policy.md
"""
