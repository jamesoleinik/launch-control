...
The "Launch Control" LinkedIn series — twelve short episodes building one project end-to-end. Each folder is self-contained: the episode README is the spec, `preflight.py` is the local test harness, and any episode-specific scripts live alongside.
...
| [6](ep-06-the-agent/) | The Agent | Declarative Launch Coordinator + knowledge substrate |
| [7](ep-07-autonomous-agents/) | Autonomous Agents | Launch Sentinel — event-triggered autonomous agent |
| [8](ep-08-code-first-agent/) | The Code-First Agent | Same skills, different runtime — Python agent that pulls skills from Dataverse |
| [9](ep-09-the-dashboard/) | The Dashboard | Generative Power Apps page deployed via `pac model genpage upload` |
| [10](ep-10-copilot-just-knows/) | Copilot Just Knows | Native Copilot intelligence over Dataverse — no agent needed |
| [11](ep-11-agentic-admin/) | Agentic Administration | The management plane is agent-driven — capacity, audit, cleanup, blast-radius |
| [12](ep-12-full-orchestra/) | Full Orchestra + Your Turn | Six surfaces in 60 seconds + open-source CTA |
...
- `apps/launch-command-center/` — the Ep 9 generative page
