...
Two modes:
  python scripts/test_ep5_locally.py --plan       # Emit human-readable test plan (markdown)
  python scripts/test_ep5_locally.py --run        # Execute tests, print colorized summary, write results md
  python scripts/test_ep5_locally.py --plan --run # Both: show plan, then run
