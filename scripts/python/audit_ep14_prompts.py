"""Episode 14 prompt preflight: verify the data shape Dataverse Intelligence will need
...
Run: python scripts/python/audit_ep14_prompts.py
"""
import os, sys
import requests
...
def main():
    print(f"Episode 14 prompt preflight (launch: {LAUNCH_NAME!r})\n")
    failures = 0
