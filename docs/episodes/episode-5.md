...
7. **Test harness** — `python scripts/test_ep5_locally.py --plan` to show
...
| [`scripts/test_ep5_locally.py`](../../scripts/test_ep5_locally.py) | Two-mode test harness — `--plan` emits markdown, `--run` executes 3 pre-flight + 3 tests. |
